                ...
                <div class="signup-content">
                    <form method="POST" action="/register" enctype="multipart/form-data" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Teacher Name"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="field" id="field" placeholder="Teacher Field"/>
                        </div>
                        <div class="form-group">
